...
## Part C — Google Classroom Items

The 17 per-school Google Classroom items are left exactly as they are. Existing automations are built on them — no changes to visibility, category, or configuration.
